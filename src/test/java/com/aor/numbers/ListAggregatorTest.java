...
public class ListAggregatorTest {
    List<Integer> list;
    List<Integer> listNeg;
    List<Integer> list8729;

    @BeforeEach
    public void lista() {
        list = Arrays.asList(1,2,4,2,5);
        listNeg = Arrays.asList(-1,-4,-5);
        list8729 = Arrays.asList(1,2,4,2);
    }
    ...
    public void max_bug_7263() {
        ...
        ListAggregator aggregator = new ListAggregator();
        int max = aggregator.max(listNeg);
...
//        ListAggregator aggregator = new ListAggregator();
//        StubListDeduplicator deduplicator = new StubListDeduplicator();
//        int distinct = aggregator.distinct(list8729, deduplicator);
//
//
